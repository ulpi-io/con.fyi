...
Add future products and legal documents using the same structure. Pages are intentionally dependency-free static HTML so they can be served by any static web container.
